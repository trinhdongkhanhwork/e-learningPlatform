...
public class WishlistServiceIplm implements WishlistService {
    ...
    public WishlistDtoResponse addWishlist(WishlistRequest wishlistDto) {
        ...
        Course course = courseRepository.findById(wishlistDto.getCourseId()).orElseThrow(()-> new AppException(ErrorCode.COURSE_NOT_FOUND));
    ...
    public List<WishlistDtoResponse> getAllWishlist(String userId) {
        ...
        return wishlist.stream().map(wishlistMapper::wishlistToWishlistDtoResponse).toList();
    }
