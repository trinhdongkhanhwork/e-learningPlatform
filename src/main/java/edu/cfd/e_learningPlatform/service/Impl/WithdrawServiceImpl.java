...
public class WithdrawServiceImpl implements WithdrawService {
    ...
    public WithdrawDto requestWithdraw(String userId, BigDecimal priceInVND) throws MessagingException {
        ...
        // Cập nhật lợi nhuận cho admin
        User adminUser = userRepository.findByRoleEntity_Id(3)
                .orElseThrow(() -> new IllegalArgumentException("Người dùng admin với role ID 3 không tồn tại"));
        adminUser.setAdminProfit(adminUser.getAdminProfit().add(adminProfit));
    ...
    public void confirmWithdraw(Long withdrawId, String otp) {
        ...
        try {
            ...
            savePaymentHistory(user, withdraw.getPrice());
    ...
    // Phương thức lưu lịch sử thanh toán
    private void savePaymentHistory(User user, BigDecimal price) {
